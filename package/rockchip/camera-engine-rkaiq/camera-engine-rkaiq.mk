...
else ifeq ($(BR2_PACKAGE_RV1126B), y)
CAMERA_ENGINE_RKAIQ_CONF_OPTS += -DISP_HW_VERSION=-DISP_HW_V35
CAMERA_ENGINE_RKAIQ_CONF_OPTS += -DCMAKE_BUILD_TYPE=MinSizeRel
CAMERA_ENGINE_RKAIQ_CONF_OPTS += -DRKAIQ_TARGET_SOC=rv1126b
...
CAMERA_ENGINE_RKAIQ_IQFILE = isp35/common/*.json
else ifeq ($(BR2_PACKAGE_RK3566_RK3568), y)
