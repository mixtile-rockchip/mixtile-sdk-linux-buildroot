...
ifeq ($(BR2_PACKAGE_ROCKCHIP_MALI_VENDOR_PACKAGE),)
...
ifeq ($(BR2_PACKAGE_ROCKCHIP_MALI_VENDOR_PACKAGE),y)
ROCKCHIP_MALI_CONF_OPTS += -Dvendor-package=true
endif
...
ifeq ($(BR2_PACKAGE_LIBGLVND)$(BR2_PACKAGE_MESA3D),yy)
ROCKCHIP_MALI_DEPENDENCIES += mesa3d
define ROCKCHIP_MALI_REMOVE_GLVND
	rm -f $(TARGET_DIR)/usr/share/glvnd/egl_vendor.d/50_mesa.json
endef
ROCKCHIP_MALI_POST_INSTALL_TARGET_HOOKS += ROCKCHIP_MALI_REMOVE_GLVND
endif
