...
ifeq ($(BR2_PACKAGE_BUSYBOX_BASH),y)
define BUSYBOX_SET_ASH_BASH
	$(call KCONFIG_DISABLE_OPT,CONFIG_BASH_IS_NONE)
	$(call KCONFIG_ENABLE_OPT,CONFIG_BASH_IS_ASH)
	$(call KCONFIG_ENABLE_OPT,CONFIG_ASH_BASH_COMPAT)
endef

define BUSYBOX_SET_HUSH_BASH
	$(call KCONFIG_DISABLE_OPT,CONFIG_BASH_IS_NONE)
	$(call KCONFIG_ENABLE_OPT,CONFIG_BASH_IS_HUSH)
